...
class VendorOrderDetailsView extends StatefulWidget {
  ...
  @override
  State<VendorOrderDetailsView> createState() => _VendorOrderDetailsViewState();
}
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              // The store reaches the customer by phone only; order chat is
          ...
          child: Column(
            children: [
              for (var i = 0; i < order.items.length; i++)
                _itemRow(order.items[i], last: i == order.items.length - 1),
            ],
          ),
        ),
        ...
        if (order.customerNotes?.isNotEmpty ?? false) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: AppColors.amberInk.withValues(alpha: 0.2),
              ),
              borderRadius: BorderRadius.circular(AppRadii.lg),
            ),
            child: Row(
